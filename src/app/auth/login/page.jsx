...
import { Eye, EyeOff, Mail, Lock, ArrowRight, Leaf, ShoppingBag } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50 flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-20 right-20 w-32 h-32 bg-teal-200 rounded-full blur-2xl opacity-30 animate-pulse" style={{ animationDelay: "1s" }}></div>
        <div className="absolute top-1/2 left-1/4 w-24 h-24 bg-blue-200 rounded-full blur-xl opacity-30 animate-pulse" style={{ animationDelay: "2s" }}></div>
      </div>
        ...
        <div className="hidden lg:block space-y-8">
          <div className="space-y-6">
            <Link href="/" className="flex items-center space-x-3">
              ...
              <span className="text-3xl font-bold text-emerald-700">Shoply</span>
            </Link>

            <div className="space-y-4">
              <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
                Welcome back to your <span className="text-emerald-600">healthy lifestyle</span>
              </h1>
              <p className="text-xl text-gray-600 leading-relaxed">
                Sign in to access your account and continue your journey towards fresh, organic living.
              </p>
            </div>
          ...
          <div className="relative w-full h-64 rounded-2xl overflow-hidden shadow-2xl">
            <Image src={vagetable} alt="Fresh organic vegetables" fill className="object-cover" />
          </div>
        </div>
