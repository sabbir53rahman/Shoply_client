...
const SignupPage = () => {
  ...
  const handleGoogleSignUp = async () => {
    setIsLoading(true);
    try {
      const googleSignUp = await googleSignIn();
      console.log("Google SignUp result:", googleSignUp);

      const { displayName, email, uid } = googleSignUp.user;

      // Dispatch to your Redux store or send to your backend
      dispatch(
        addUser({
          name: displayName,
          email: email,
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Create your account and start your journey towards a
