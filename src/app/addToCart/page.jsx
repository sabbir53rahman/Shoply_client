  ...
  return (
    <div className="">
      ...
      <div className="max-w-5xl mx-auto min-h-screen  p-4 md:p-8">
        ...
        {data === undefined ||
          (data.length < 1 && (
            <p className="text-center py-10">
              You have no cart products.{" "}
              <Link className="text-sky-400" href="/products">
                See products
              </Link>
            </p>
          ))}
        ...
        <div className="space-y-4 mb-8">
          {data?.map((item) => (
            <div
              ...
              className="bg-white rounded-lg shadow-md p-3 md:p-6 flex flex-co sm:flex-row items-center gap-3 md:gap-6"
            >
              {/* Product Image */}
              ...
              <div className="flex flex-col-reverse sm:flex-row items-center gap-2 md:gap-6">
                <div className="lg:text-xl font-medium text-gray-600 lg:min-w-[80px] text-right">
        ...
        {!currentUser && (
          <div className="w-full text-center pt-3 pb-10">
            <Link className="mx-auto text-blue-300" href={"/auth/login"}>
              please login first
            </Link>
          </div>
        )}
        ...
        {data === undefined || data.length < 1 ? (
          <button
            disabled
            className="w-[80%] mx-auto  block text-center px-2 bg-gray-400 text-white text-lg py-2 rounded-lg font-medium"
          >
            Proceed to Pay
          </button>
        ) : (
          <div className="w-full py-6">
            <Link
              href={`/checkout`}
              className="w-[80%] mx-auto  block text-center px-2 bg-emerald-600 hover:bg-emerald-700 text-white text-lg py-2 rounded-lg font-medium"
            >
              Proceed to Pay
            </Link>
          </div>
